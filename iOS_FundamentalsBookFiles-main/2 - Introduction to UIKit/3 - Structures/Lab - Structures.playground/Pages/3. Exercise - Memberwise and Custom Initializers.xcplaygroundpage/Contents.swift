...
let favoriteBook = Book(title: "SwiftCS", author: "Sai and Vishal", pages: 200, price: 19.99)
print("\(favoriteBook.title) and \(favoriteBook.author) and \(favoriteBook.pages) and $\(favoriteBook.price)")
...
var myHeight = Height(heightInInches: 66.0)
