...
var vishal = user(name: "Vishal", age: 17, height: 66.0, weight: 110, activityLevel: 7)
print("\(vishal.name) and \(vishal.age) and \(vishal.height) and \(vishal.weight) and \(vishal.activityLevel)")
/*:
